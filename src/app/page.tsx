        ...
        <div className="container mx-auto max-w-4xl relative z-10">
          ...
          <div className="glass-card rounded-[2.5rem] p-12 md:p-16 text-center">
            ...
            <p className="text-lg text-chocolate/60 leading-relaxed mb-8">
              אנחנו מפיצים מגוון רחב של עוגות, קינוחים ומאפים מעוצבים מהקונדיטוריות המובילות בארץ.
              קו חלוקה ארצי, מלאי זמין ומחירי סיטונאות מיוחדים לבתי קפה, מסעדות, קייטרינג ועסקים.
            </p>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-3 flex items-center justify-center gap-1 text-gold text-sm">
                    ...
                    <svg
                      className="w-4 h-4 group-hover:translate-x-[-4px] transition-transform"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
          ...
          <div className="glass-card rounded-3xl p-8 md:p-12">
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 lg:grid-cols-9 gap-3">
              {catalog.slice(0, 8).map((category, index) => (
                <Link
                  key={index}
                  href={`/menu/${category.slug}`}
                  className="bg-chocolate/5 hover:bg-gold/20 rounded-2xl p-3 text-center transition-all duration-300 group"
                >
                  <div className="text-2xl mb-1 group-hover:scale-110 transition-transform">
                    {category.icon}
                  </div>
                  <span className="text-chocolate/70 group-hover:text-chocolate font-medium text-xs md:text-sm">
                    {category.name}
                  </span>
                </Link>
              ))}
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8">
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-sm font-semibold text-chocolate truncate">
                    info@lenyvron.com
                  </div>
                </div>
              </a>
